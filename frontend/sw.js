...
const SHELL = [
  ...
  "./js/callSignaling.js",
  "./js/webrtc.js", 
  "./vendor/bip39.bundle.mjs",              
  "./vendor/bip39-wordlist-english.bundle.mjs",
  "./vendor/curves-ed25519.bundle.mjs",
  "./vendor/ciphers-chacha.bundle.mjs",
  "./js/qr.js",
  "./vendor/qrcode.bundle.mjs",
  "./vendor/jsqr.bundle.mjs",         
  "./icons/icon-192.png",
  "./icons/icon-512.png",
];
